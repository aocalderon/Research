...
public class RoutingExample {
    public static void main(String[] args) {
        String osmFile = args.length == 1 ? args[0] : "/home/acald013/opt/sumo/sumo_test/ny/ny.osm";
        GraphHopper hopper = createGraphHopperInstance(osmFile);
        routing(hopper);
        //speedModeVersusFlexibleMode(hopper);
        //alternativeRoute(hopper);
        //customizableRouting(osmFile);
    ...
    public static void routing(GraphHopper hopper) {
        ...
        GHRequest req = new GHRequest(40.684293985, -74.00944173, 40.72231, -74.0106).
	...
	for (GHPoint p: pointList) {
	    System.out.println("POINT(" + p.getLon() + " " + p.getLat() + ")");
	}
