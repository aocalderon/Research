...
parser.add_argument("--bfe_dataset", "-f", default="/home/and/Documents/PhD/Research/Datasets/Berlin/B40K_d.tsv", help="BFE dataset")
parser.add_argument("--pflock_path", "-k", default="Datasets/Berlin/", help="PFlock path")
parser.add_argument("--pflock_dataset", "-g", default="B40K_d", help="PFlock dataset")
