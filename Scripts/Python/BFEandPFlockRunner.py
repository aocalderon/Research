...
parser.add_argument("--bfe_dataset", "-f", default="/home/and/Documents/PhD/Research/Datasets/Berlin/B20K.tsv", help="BFE dataset")
parser.add_argument("--pflock_path", "-k", default="Datasets/Berlin/", help="PFlock path")
parser.add_argument("--pflock_dataset", "-g", default="B20K", help="PFlock dataset")
