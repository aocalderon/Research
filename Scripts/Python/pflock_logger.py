            ...
            for stage in stages:
                ...
                if status == 'ACTIVE':
                    ...
                    for index, row in tasks.iterrows():
                        #logging.info(row)
                        logging.info("TASKS|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}".format(timer(start), appID, executors, executorID, hostPort, stageID, stageName, row['ID'], row['Locality Level'], row['Launch Time'], row['Duration  ▾'], row['Input Size / Records'], row['Status']))
