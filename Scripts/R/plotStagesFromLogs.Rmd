...
## Plotting SpatialJoin Method

```{r SJPlot, echo=FALSE, fig.width=10.5, fig.height=7.5, fig.align='center'}
...
## Plotting MergeLast Method

```{r MLPlot, echo=FALSE, fig.width=10.5, fig.height=7.5, fig.align='center'}
