...
RESULTS_NAME = "FFMultinodeDeltaSpeedup"
...
title = "Multinode Speed Up by Delta [Berlin_160K, 4 cores per node, 1 thread per core]"
...
title = "Multinode Speed Up by Delta Boxplot [Berlin_160K, 4 cores per node, 1 thread per core]"
...
title = "Multinode Speed Up by Delta without outliers [Berlin_160K, 4 cores per node, 1 thread per core]"
