...
Using a grid with small cells...

[Grid B1 (15x30 partitions)](Figures/Grid1/B1.png)
[Grid B2 (30x30 partitions)](Figures/Grid1/B2.png)
[Grid B3 (45x30 partitions)](Figures/Grid1/B3.png)

```{r echo=FALSE}
fields = c("Timestamp", "Tag", "appId", "Cores", "Executors", "Epsilon", "Mu", "Delta", "Time", "Load")
data_path = "~/Documents/PhD/Research/Scripts/R/R17/nohubGrid1.txt"
data = enframe(read_lines(data_path), name = "n", value = "line") %>% select(line) %>%
  ...
  filter(Epsilon == "100.0" | Epsilon == "110.0")
...
data$Epsilon   = factor(data$Epsilon,   levels = c("90.0", "100.0","110.0"))
