...
[Grid B1 (304 partitions)](Figures/KDBTree1/B1.png)
[Grid B2 (552 partitions)](Figures/KDBTree1/B2.png)
[Grid B4 (1108 partitions)](Figures/KDBTree1/B4.png)

* KDBTree parameters: Max entries per node=500, Max levels=1024. 

```{r echo=FALSE}
fields = c("Timestamp", "Tag", "appId", "Cores", "Executors", "Epsilon", "Mu", "Delta", "Time", "Load")
data_path = "~/Documents/PhD/Research/Scripts/R/R17/nohubKDBTree1.txt"
