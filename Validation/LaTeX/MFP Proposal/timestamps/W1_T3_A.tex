\section*{Maximal disks $t_3$}
	...
	\begin{pspicture}(0,0.0)(13,12)
		...
		\ncline[linecolor=cyan,linestyle=dashed]{C 2}{C 4}
		
		\ncline[linecolor=orange,linestyle=dashed]{E 0}{E 2}
		\ncline[linecolor=orange,linestyle=dashed]{E 2}{E 4}
		...
		\ncline[linecolor=brown,linestyle=dashed]{J 2}{J 4}

		\ncline[linecolor=black,linestyle=dashed]{L 2}{L 4}
