		...
		\uput[0](4.0, 0)  {$\langle A_1, A_2, A_3, A_4 \rangle$}
		\uput[0](4.0, 1)  {$\langle B_0, B_1, B_3 \rangle$}
		\uput[0](4.0, 2)  {$\langle C_0, C_1, C_2, C_3, C_4 \rangle$}
		\uput[0](4.0, 3)  {$\langle D_0, D_1, D_4 \rangle$}
		\uput[0](4.0, 4)  {$\langle E_0, E_2, E_3, E_4 \rangle$}
		\uput[0](4.0, 5)  {$\langle F_1, F_2, F_4 \rangle$}
		\uput[0](4.0, 6)  {$\langle G_0, G_2, G_3, G_4 \rangle$}
		\uput[0](4.0, 7)  {$\langle H_1, H_3, H_4 \rangle$}
		\uput[0](4.0, 8)  {$\langle I_0, I_1, I_3, I_4 \rangle$}
		\uput[0](4.0, 9)  {$\langle J_0, J_1, J_2, J_3, J_4 \rangle$}
		\uput[0](4.0,10)  {$\langle K_0, K_2 \rangle$}
		\uput[0](4.0,11)  {$\langle L_1, L_2, L_3, L_4 \rangle$}
