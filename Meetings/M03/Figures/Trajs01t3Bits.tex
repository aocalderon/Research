...
\begin{tikzpicture}
    ...
    \node[partition] (partitions) at (\xMax, 1.5) {
        \begin{tabular}{l l l l l l l l r}
            $o_1: $ & $\{\color{blue}{o_2,o_3}$$\}_{t_1}$  & $\{o_2, o_3, o_4\}_{t_2}$ & $\{o_2, o_3, o_4\}_{t_3}$ & $\color{blue}{o_2}$$:$     & 1 & 1 & 1 & $\surd$ \\[\rowspace cm]
                    &                       &                           &                           & $\color{blue}{o_3}$$:$                    & 1 & 1 & 1 & $\surd$ \\[\rowspace cm]
                    &                       &                           &                           & $\color{blue}{o_2,o_3}$$:$                & 1 & 1 & 1 & $\surd$ \\[\rowspace cm]
            $o_2: $ & $ \{\color{red}{o_3}$$\}_{t_1}$      & $\{o_3, o_4\}_{t_2}$      & $\{o_3, o_4\}_{t_3}$      & $\color{red}{o_3}$$:$      & 1 & 1 & 1 & $\surd$ \\[\rowspace cm]
            $o_3: $ & $ \{ \}_{t_1}$        & $\{o_4\}_{t_2}$           & $\{o_4\}_{t_3}$           &   \\[\rowspace cm]
            $o_4: $ & $ \{\color{brown}{o_5}$$\}_{t_1}$     & $\{\}_{t_2}$              & $\{\}_{t_3}$              & $\color{brown}{o_5}$$:$   & 1 & 0 & 0 & $\times$ \\[\rowspace cm]
            $o_5: $ & $ \{ \}_{t_1}$        & $\{\}_{t_2}$              & $\{\}_{t_3}$              &   \\
        \end{tabular}
    };
