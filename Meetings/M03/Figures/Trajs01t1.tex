...
\begin{tikzpicture}
    ...
    \node[partition] (partitions) at (\xMax, 1.5) {
        \begin{tabular}{l l}
            $o_1: $ & $\{o_2, o_3\}_{t_1}$  \\[\rowspace cm]
            $o_2: $ & $ \{o_3\}_{t_1}$      \\[\rowspace cm]
            $o_3: $ & $ \{ \}_{t_1}$        \\[\rowspace cm]
            $o_4: $ & $ \{o_5 \}_{t_1}$     \\[\rowspace cm]
            $o_5: $ & $ \{ \}_{t_1}$        \\
        \end{tabular}
    };
