...
pflock6 <- enframe(read_lines("pflock6_la25k_SvC.txt"), value = "line") |>
  ...
  mutate(partitions = recode(partitions,"1009" = "1000", "901" = "900", "802" = "800", "700" = "700", "601" = "600", "499" = "500", "391" = "400", "295" = "300", "202" = "200", "103" = "100")) |>
...
W = 10
H = 6
ggsave(paste0("pflock6_la25k_SvC.pdf"), width = W, height = H)
