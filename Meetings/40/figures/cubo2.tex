...
\coordinate (P0) at (1,0,1); \draw[point] (P0) circle (0.05);
\coordinate (P1) at (3,0.25,1); \draw[point] (P1) circle (0.05);
\coordinate (P2) at (3.25,1.25,1); \draw[point] (P2) circle (0.05);
\coordinate (P3) at (1.25,1.5,1); \draw[point] (P3) circle (0.05);
\coordinate (P4) at (0.75,2.15,1); \draw[point] (P4) circle (0.05);
\coordinate (P5) at (1.25,2.55,1); \draw[point] (P5) circle (0.05);
\coordinate (P6) at (3.5,2.75,1); \draw[point] (P6) circle (0.05);
