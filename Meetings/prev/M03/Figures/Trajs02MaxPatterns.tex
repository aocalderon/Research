...
\begin{tikzpicture}
    ...
    \node[partition] (partitions) at (\xMax+\gap+\gap, 3) {
    ...
    \node[partition] (maximals) at (\xMax+\gap+\gap, 0.5) {
    \begin{tabular}{r r r r}
        \hline
        Partition & Maximal Pattern & Support ($\mu$) \\[\rowspace cm]
        \hline
        $o_1$     & $\{o_2, o_3\}$  & 3   \\[\rowspace cm]
                  & $\{o_3, o_4\}$  & 3   \\[\rowspace cm]
                  & $\{o_5, o_6\}$  & 3   \\[\rowspace cm]
        \hline
        $o_2$     & $\{o_3\}$       & 3   \\[\rowspace cm]
        \hline
        $o_5$     & $\{o_6\}$       & 3   \\[\rowspace cm]
        \hline
    \end{tabular}
