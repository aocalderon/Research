...
class FFConf(args: Seq[String]) extends ScallopConf(args) {
  ...
  val customx:      ScallopOption[Double]  =  opt[Double]   (default  = Some(10.0))
  val customy:      ScallopOption[Double]  =  opt[Double]   (default  = Some(10.0))
  val customxmf:    ScallopOption[Double]  =  opt[Double]   (default  = Some(10.0))
  val customymf:    ScallopOption[Double]  =  opt[Double]   (default  = Some(10.0))
