...
object MF_QuadTree{
  ...
  def run(spark: SparkSession, points: PointRDD, MF1Partitioner: QuadTreePartitioner, MF2Partitioner: QuadTreePartitioner, params: FFConf, timestamp: Int = -1, info: String = ""): Unit = {
  ...
  def main(args: Array[String]) = {
    ...
    logStart(stage)
    val maximals = MF_QuadTree.run(spark, points, QTPartitioner, QTPartitioner, params)
    logEnd(stage, timer, 0)
